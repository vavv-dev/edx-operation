...
"""
edx_operation documentation build configuration file.
...
VERSION = get_version("../edx_operation", "__init__.py")
...
html_context = {
    ...
    "github_repo": "edx-operation",  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/zi-eum/edx-operation",
...
#
# html_title = 'edx_operation v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call(
        [
            ...
            "-o",
            docs_path,
            os.path.join(root_path, "edx_operation"),
            os.path.join(root_path, "edx_operation/migrations"),
        ]
    )
