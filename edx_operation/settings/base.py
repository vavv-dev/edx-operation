...
from edx_operation.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get("EDX_OPERATION_SECRET_KEY", "insecure-secret-key")
...
ROOT_URLCONF = "edx_operation.urls"

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = "edx_operation.wsgi.application"
